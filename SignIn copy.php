            ...
            <div class="col-md-6 right-box" id="signinbox">
                <div class="row justify-content-center">
                    ...
                    <div class=" col-12 input-group mb-3">
                        <label class=" col-12 form-label">Email Address</label>
                        <input type="text" class=" form-control form-control-lg bg-light fs-6 rounded-3" id="SIemail" placeholder="Amarabandu@gmail.com">
                    </div>

                    <div class=" col-12 input-group mb-1">
                        <label class=" col-12 form-label">Password</label>
                        <input type="password" class=" form-control form-control-lg bg-light fs-6 rounded-3" id="SIpassword" placeholder="**********">
